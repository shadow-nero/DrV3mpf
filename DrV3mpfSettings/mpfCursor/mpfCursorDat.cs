...
public class mpfCursorDat
{
    private Stream stream;
    public List<mpfCursorChapter> Chapters = new List<mpfCursorChapter>();

    public mpfCursorDat() { }
    public mpfCursorDat(string path)
    {
    ...
    public void ReadHeader()
    {
        ...
        for (int i = 0; i < 7; i++)
            Chapters.Add(new mpfCursorChapter(reader));
    }
    ...
    public void ImportChapter(int chapterIndex, string filePath)
    {
        ...
        Chapters[chapterIndex] = mpfCursorChapter.ReadFromText(filePath);
    ...
    public void ImportAllChapters(string inputFolder)
    {
        ...
        {
            mpfCursorChapter chapter = mpfCursorChapter.ReadFromText(file);
